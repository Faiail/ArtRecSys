...
class ArtGraphWithSplit():
    ...
    def write_info(self):
        ...
        pandas.DataFrame.from_dict(node_has_feats).to_csv(os.path.join(self.split_folder, "nodetype-has-split.csv"), header=True, index=False)
    ...
    def write(self, full=True):
        ...
        if full == False:
            ...
            self.relations.remove_relations(excluded_relation=self.labels, valid_nodes=valid_nodes, test_nodes=test_nodes)
